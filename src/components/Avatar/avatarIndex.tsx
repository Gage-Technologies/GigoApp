...
import Clothe from 'avataaars/src/avatar/clothes';
import Face from 'avataaars/src/avatar/face';
import Skin from 'avataaars/src/avatar/Skin';
import Top from 'avataaars/src/avatar/top';
import Svg, { Circle, Path, G, Use, Defs, Mask, Rect } from 'react-native-svg';
